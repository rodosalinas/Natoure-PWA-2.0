...
export const ResumeExp = (props: ExperieceElement): JSX.Element => {
    return (
      <Card>
        ...
        <span className="buttons"><button><span className="btnspn">Personaliza tu experiencia <span className="icon"><FaWhatsappSquare /></span> o <span className="icon"><FaEnvelope /></span></span></button></span>
        </div>
      </Card>
    )
  }
